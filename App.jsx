...
import qrSenar from './assets/qrSenar.png'       
    ...
    <>
        ...
        <div className="container">
          ...
          <div className="desafios-cards">
            <DesafiosCard
              ...
              description="Secas prolongadas e inundações repentinas resultam in perdas significativas de colheitas e prejuízos financeiros."
            />
      ...
      <section className="solucao-section" id="solucao">
        <div className="container">
          ...
          {/* ================= QR CODES ================= */}
          <div className="qr-codes-container" style={{
            display: 'flex', 
            ...
            <div className="qr-card" style={{
              ...
              <img src={qrTelegram} alt="QR Code Plataforma" style={{ width: '100%', height: 'auto', borderRadius: '8px' }} />
              <h5 style={{ marginTop: '15px', fontSize: '16px', color: '#333', fontWeight: 'bold' }}>Acesse a Plataforma</h5>
              <p style={{ fontSize: '12px', color: '#666', margin: '0' }}>Escaneie para interagir com o nosso bot Dona Rosa no Telegram</p>
            </div>
            ...
            <div className="qr-card" style={{
              ...
              <img src={qrSenar} alt="QR Code Portal SENAR" style={{ width: '100%', height: 'auto', borderRadius: '8px' }} />
              <h5 style={{ marginTop: '15px', fontSize: '16px', color: '#333', fontWeight: 'bold' }}>Educação SENAR</h5>
              <p style={{ fontSize: '12px', color: '#666', margin: '0' }}>Acesse a plataforma oficial de capacitação rural</p>
            </div>
          </div>
          {/* ============================================================================= */}
      ...
      <section className="secao-mapa-integrada" id="elo-rural" style={{ padding: '40px 0', background: '#fff' }}>
        <div className="container">
